...
flow add processor -n proc1 -g https://radiantone:xxxx@github.com/radiantone/pyfi-processors#egg=pyfi-processor -m ext.processors.sample -h phoenix
flow add processor -n proc2 -g https://radiantone:xxxx@github.com/radiantone/pyfi-processors#egg=pyfi-processor -m ext.processors.sample -h agent1
flow add processor -n proc3 -g https://radiantone:xxxx@github.com/radiantone/pyfi-processors#egg=pyfi-processor -m ext.processors.sample -h agent2
