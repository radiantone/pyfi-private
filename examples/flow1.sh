...
flow add processor -n proc1 -g https://radiantone:xxxx@github.com/radiantone/pyfi-processors#egg=pyfi-processor  -m ext.processors.sample
flow add processor -n agent1proc1 -g https://radiantone:xxxx@github.com/radiantone/pyfi-processors#egg=pyfi-processor  -m ext.processors.sample -h agent1
flow add processor -n agent2proc1 -g https://radiantone:xxxx@github.com/radiantone/pyfi-processors#egg=pyfi-processor  -m ext.processors.sample -h agent2
