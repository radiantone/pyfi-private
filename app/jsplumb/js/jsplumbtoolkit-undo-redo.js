...
var EdgeAction = /** @class */ (function () {
    ...
    EdgeAction.prototype._add = function () {
        ...
        if (this.geometry != null) {
            connectOptions.geometry = this.geometry;
        }
...
var EdgePathCommand = /** @class */ (function () {
    function EdgePathCommand(surface, edge, originalGeometry, geometry) {
        this.surface = surface;
        this.edge = edge;
        this.originalGeometry = originalGeometry;
        this.geometry = geometry;
    }
    EdgePathCommand.prototype._apply = function (g) {
        var connection = this.surface.getRenderedConnection(this.edge.getId());
        if (g != null) {
            connection.getConnector().importGeometry(g, connection);
        }
        else {
            connection.getConnector().clearEdits();
        }
        connection.repaint();
    };
    EdgePathCommand.prototype.undo = function () {
        this._apply(this.originalGeometry);
    };
    EdgePathCommand.prototype.redo = function () {
...
var AddGroupMemberAction = /** @class */ (function (_super) {
    __extends(AddGroupMemberAction, _super);
    function AddGroupMemberAction() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    AddGroupMemberAction.prototype.redo = function () {
        this.toolkit.addToGroup(this.node, this.group);
    };
    AddGroupMemberAction.prototype.undo = function () {
        this.toolkit.removeFromGroup(this.node);
    };
    return AddGroupMemberAction;
}(GroupAction));
var RemoveGroupMemberAction = /** @class */ (function (_super) {
    __extends(RemoveGroupMemberAction, _super);
    function RemoveGroupMemberAction() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    RemoveGroupMemberAction.prototype.redo = function () {
        this.toolkit.removeFromGroup(this.node);
    };
    RemoveGroupMemberAction.prototype.undo = function () {
        this.toolkit.addToGroup(this.node, this.group);
    };
...
var jsPlumbToolkitUndoRedo = /** @class */ (function () {
    ...
    jsPlumbToolkitUndoRedo.prototype._bindListeners = function () {
        ...
        this.toolkit.bind("graphCleared", function () {
            _this.clear();
        });
        ...
        this.toolkit.bind("edgePathEdited", function (p) {
            _this.command(new EdgePathCommand(_this.surface, p.edge, p.originalGeometry, p.geometry));
        });
        ...
        if (this.surface != null) {
            this.surface.bind("nodeMoveEnd", function (p) {
                if (p.originalPosition != null) {
                    _this.command(new MoveAction(p.node || p.group, p.originalPosition, p.pos, _this.surface));
                }
            });
        }
        this.toolkit.bind("group:addMember", function (p) {
            _this.command(new AddGroupMemberAction(p.node, p.group, _this.toolkit));
        });
        this.toolkit.bind("group:removeMember", function (p) {
            _this.command(new RemoveGroupMemberAction(p.node, p.group, _this.toolkit));
        });
    };
    /**
