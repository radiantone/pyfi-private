...
var ATTR_IS_GROUP = "jtk-is-group";
...
var jsPlumbToolkitDropManager = /** @class */ (function () {
    function jsPlumbToolkitDropManager(params) {
        ...
        this.canvasMoveListener = function (e) {
            ...
            _this.isCurrentlyOnCanvasElement = eventSource === _this.surfaceCanvas || (_this.canvasSelector != null && jsPlumbUtil.matchesSelector(eventSource, _this.canvasSelector));
        };
        ...
        this.katavorio.draggable(this.source, {
            ...
            start: function (p) {
                ...
                if (_this.onCanvasDrop && _this.canvasDropFilter(_this.candidateData)) {
                    ...
                    _this.isCurrentlyOnCanvasElement = false;
                    // TODO this does not work for touch devices.  for those, it will be necessary to test if the
    ...
    jsPlumbToolkitDropManager.prototype.setSurface = function (surface) {
        this.surface = surface;
        this.toolkit = surface.getToolkit();
        this.surfaceCanvas = surface.getContainer();
        this._jsPlumb = surface.getJsPlumb();
    };
    jsPlumbToolkitDropManager.prototype.isEffectivelyOnCanvas = function (e) {
...
var SurfaceDropManager = /** @class */ (function () {
    function SurfaceDropManager(options) {
        ...
        this.groupIdentifier = options.groupIdentifier || (function (d, el) { return el.getAttribute(ATTR_IS_GROUP) === "true"; });
        ...
        this.allowNodeDropOnCanvas = options.allowNodeDropOnCanvas !== false;
        ...
        var dropManagerOptions = {
            ...
            onCanvasDrop: this.allowDropOnCanvas ? function (data, canvasPosition, draggedElement, e, position) {
                ...
                else if (_this.allowNodeDropOnCanvas) {
            ...
            onDrop: function (data, target, draggedElement, e, position, canvasLocation, targetLocation, locationOnTarget) {
                if (_this.allowDropOnGroup) {
                    var groupDragged = _this.groupIdentifier(data, draggedElement);
                    if (target.objectType === GROUP_TYPE && !groupDragged) {
                        var type = _this.typeGenerator(data);
                        var objData = _this._mapToPositionAttributes({
                            group: target.id,
                        ...
                        _this.toolkit.addFactoryNode(type, objData, function (node) {
                            ...
                            _this.surface.relayoutGroup(target);
                        });
                    }
                }
            },
    ...
    SurfaceDropManager.prototype.setSurface = function (s) {
        this.surface = s;
        this.toolkit = this.surface.getToolkit();
        this.modelPositionAttributes = this.surface.getModelPositionAttributes();
