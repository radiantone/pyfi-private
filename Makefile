...
.PHONY: up
up:
	docker compose up -d postgresdb redis rabbitmq rabbitmq2 websockets websockets2 nginx globalsocket clientsocket mongodb web api pgadmin influxdb metabase
