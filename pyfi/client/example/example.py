...
processor2 = Processor(name='proc2', user=USER, module='pyfi.processors.sample', hostname='radiant', concurrency=6,
                       branch='main',
                       gitrepo='https://radiantone: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@github.com/radiantone/pyfi-processors#egg=pyfi-processor')
...
do_something2 = Socket(name='proc2.do_something', user=USER, processor=processor2, queue={'name': 'pyfi.queue1'},
                       task='do_something')
