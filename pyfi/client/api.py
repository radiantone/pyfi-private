...
from .objects import Node, Processor, Task, Socket, Queue, Plug, Work, Agent, Argument, Worker
from .decorators import processor, task, node, agent, worker
__all__ = (
    'Processor', 'Task', 'Socket', 'Agent', 'Queue', 'Plug', 'Work', 'Argument', 'Node', 'Worker',
    'processor', 'task', 'node', 'agent', 'worker',
    'parallel',
    'pipeline',
    'flatten',
    'chunk',
