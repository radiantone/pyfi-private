...
class CleanCommand(Command):
    ...
    CLEAN_FILES = './celerybeat* ./*.out ./*.log ./build ./dist ./__pycache__ **/*/__pycache__ ./*.pyc ./ssh*py ./*.tgz ./.pytest_cache ./*.egg-info'.split(
        ' ')
...
setup(
    ...
    url=about['__url__'],
    packages=['pyfi', 'pyfi.tests', 'pyfi.processor', 'pyfi.api', 'pyfi.api.resource', 'pyfi.api.resource.dto', 'pyfi.server', 'pyfi.worker', 'pyfi.agent', 'pyfi.celery',
