...
setup(
    ...
    url=about['__url__'],
    packages=['pyfi', 'pyfi.tests', 'pyfi.scheduler', 'pyfi.config', 'pyfi.client', 'pyfi.api', 'pyfi.api.resource', 'pyfi.api.resource.dto', 'pyfi.server', 'pyfi.worker', 'pyfi.agent', 'pyfi.celery',
