                    ...
                    return {
                        ...
                        link: function (scope, element, attrs, controller) {
                            ...
                            jsPlumb.extend(p, {
                                ...
                                templateRenderer: {
                                    render:function (directiveId, data, _toolkit, objectType) {
                            ...
                            jsPlumbToolkit.ready(function () {
                                ...
                                scope.surface.bind("edgeAdded", function(data) {
                                    scope.surface.getJsPlumb().revalidate(data.connection.source);
                                });
