        ...
        <q-menu context-menu>
          <q-list dense>
            ...
            <q-item
              clickable
              v-close-popup
              @click="viewVariablesDialog = true"
            >
              <q-item-section side>
        ...
        <q-card style="padding: 0px;">
          ...
          <q-card-section>
            ...
            >
              ...
              >
                <q-tooltip>Save to Library</q-tooltip>
              </q-btn>
              <q-btn
                dense
                flat
              ...
              >
                <q-tooltip>Run Processor</q-tooltip>
              </q-btn>
              <q-btn
                dense
                flat
              ...
              >
                <q-tooltip>Stop Processor</q-tooltip>
              </q-btn>
              <q-separator style="margin-right: 8px;" />
              <q-btn
                dense
              ...
              >
                <q-tooltip>Save Processor</q-tooltip>
              </q-btn>
              <q-btn
                dense
                flat
                ...
                style="margin: 3px; padding: 2px; border: 1px solid #abbcc3;"
              >
                <q-tooltip>Publish Processor</q-tooltip>
              </q-btn>
            </q-toolbar>
            <q-toolbar style="margin-top: 0px; min-height: 20px;">
              <q-btn
                ...
                @click="copyNodes"
              >
                <q-tooltip>Copy Processor</q-tooltip>
              </q-btn>
              <q-separator style="margin-right: 8px;" />
              ...
              >
                <q-tooltip>Delete Processor</q-tooltip>
              </q-btn>
            </q-toolbar>
          </q-card-section>
        </q-card>
              ...
              for (var i = 0; i < sourceEdges.length; i++) {
                ...
                if (sourceNode === params.source.getNode()) {
                  if (sourceEdge.target.getNode() === params.target.getNode()) {
                    const argname = targetEdges[0].target.data.name
